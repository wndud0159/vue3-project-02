...
<div class="flex flex-col h-screen overflow-y-scroll items-center pt-24 pb-48 md:pb-10 px-3 md:px-20">
    ...
    <div v-if="step1 && health.length" class="w-full">
        ...
        <div class="w-full flex justify-center mb-10">
            <textarea v-model="health[0].answer_text" placeholder="희망사항" class=" w-full resize-none md:w-1/2 outline-none py-2 px-2  focus:border-primary border focus:ring-4 focus:ring-primary focus:ring-opacity-25 ring-gray-300  rounded-md border-gray-300"
            rows="4">
            </textarea>
        </div>
    </div>
    ...
    <div v-if="step2 && health.length" class="w-full">
        ...
        <!-- text section -->
        <div class="w-full flex justify-center mb-10">
            <textarea v-model="health[1].answer_text" placeholder="희망사항" class=" w-full resize-none md:w-1/2 outline-none py-2 px-2  focus:border-primary border focus:ring-4 focus:ring-primary focus:ring-opacity-25 ring-gray-300  rounded-md border-gray-300"
             rows="4">
            </textarea>
        </div>
    </div>
    ...
    <!-- step3 -->
    <div v-if="step3 && health.length" class="w-full">
        <!-- radio section -->
        <!-- <div class="text-xl mb-10 flex flex-col items-center w-full space-y-3">
            <div class="bg-gray-100 px-3 md:w-1/2 py-3 flex items-center space-x-2 w-full">
        ...
        <!-- <div class="text-xl mb-10 flex flex-col items-center w-full space-y-3">
            <div class="bg-gray-100 px-3 md:w-1/2 py-3 flex items-center space-x-2 w-full">
                <input v-model="health[2].answer_box" class="w-8 h-8" type="checkbox" value="선택형1"><span>선택형1</span>
            </div>
            <div class="bg-gray-100 px-3 md:w-1/2 py-3 flex items-center space-x-2 w-full">
                <input v-model="health[2].answer_box" class="w-8 h-8" type="checkbox" value="선택형2"><span>선택형2</span>
            </div>
        </div> -->
        <!-- text section -->
        <div class="w-full flex justify-center mb-10">
            <textarea v-model="health[2].answer_text" placeholder="희망사항" class=" w-full resize-none md:w-1/2 outline-none py-2 px-2  focus:border-primary border focus:ring-4 focus:ring-primary focus:ring-opacity-25 ring-gray-300  rounded-md border-gray-300"
            rows="4">
            </textarea>
        </div>
    </div>
    ...
    <!-- step4-->
    <div v-if="step4 && health.length" class="w-full">
        <!-- radio section -->
        <!-- <div class="text-xl mb-10 flex flex-col items-center w-full space-y-3">
            <div class="bg-gray-100 px-3 md:w-1/2 py-3 flex items-center space-x-2 w-full">
                <input v-model="health[3].answer_box" class="w-8 h-8" type="radio" value='네'><span>네</span>
            </div>
            <div class="bg-gray-100 px-3 md:w-1/2 py-3 flex items-center space-x-2 w-full">
    ...
    <div v-if="health.length" class="flex  justify-center w-full">
        <div v-if="step1" class="">
            ...
            <button v-if="!health[0].answer_text && !health[0].answer_box.length" class=" bg-gray-100 py-3 px-10 rounded-lg">저장 / 다음</button>    
            <button v-if="health[0].answer_text || health[0].answer_box.length" @click="onSaveStep1" class=" bg-yellow-300 py-3 px-10 rounded-lg">저장 / 다음</button>
            <div>
        ...
        <div v-if="step2" class=" "> 
            ...
            <button v-if="!health[1].answer_text && !health[1].answer_box.length" class=" bg-gray-100 py-3 px-10 rounded-lg">저장 / 다음</button>    
            <button v-if="health[1].answer_text || health[1].answer_box.length" @click="onSaveStep2" class=" bg-yellow-300 py-3 px-10 rounded-lg">저장 / 다음</button>
            <div>
        ...
        <div v-if="step3" class=" ">
            ...
            <button v-if="!health[2].answer_text && !health[2].answer_box.length" class=" bg-gray-100 py-3 px-10 rounded-lg">저장 / 다음</button>  
            <button v-if="health[2].answer_text || health[2].answer_box.length" @click="onSaveStep3" class=" bg-yellow-300 py-3 px-10 rounded-lg">저장 / 다음</button>  
            <div>
        ...
        <div v-if="step4" class=" ">
            ...
            <button v-if="!health[3].answer_text && !health[3].answer_box.length" class=" bg-gray-100 py-3 px-10 rounded-lg">저장 / 다음</button>  
            <button v-if="health[3].answer_text || health[3].answer_box.length" @click="onSaveStep4" class=" bg-yellow-300 py-3 px-10 rounded-lg">저장 / 다음</button>  
            <div>

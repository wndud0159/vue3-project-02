...
export default {
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            const collbackURI = router.currentRoute.value.query.collbackuri;
            console.log(collbackURI);
            ...
            await axios
                .post("https://us-central1-iback-project.cloudfunctions.net/authWithNaver", code, {})
                .then((response) => {
        ...
        const getProfileNaver = async (accesstoken) => {
            ...
            await axios
                .post("https://us-central1-iback-project.cloudfunctions.net/getProfileNaver", code, {})
                .then(async (response) => {
                    ...
                    try {
                        await axios
                            .post("https://us-central1-iback-project.cloudfunctions.net/authWithFirebase", userData.value[0], {})
                            .then(async (response) => {
                                console.log("get firebase token");
                                await auth.signInWithCustomToken(response.data).then((response) => {
                        ...
                        await USER_COLLECTION.where("uid", "==", userData.value[0].userId)
                            .get()
